...
public class SpatialQueriesTests {
	...
	public static void configure(){
		...
		point1.setObs("obs");
		point1.setType("type");		
		point1.setCoordenate(new Coordinates(0, 0));
		
		point2 = new Point();
		point2.setName("name");
		point2.setObs("obs");
		point2.setType("type");		
		point2.setCoordenate(new Coordinates(0, 1));
		
		point3 = new Point();
		point3.setName("name");
		point3.setObs("obs");
		point3.setType("type");		
		point3.setCoordenate(new Coordinates(1, 0));
		
		point4 = new Point();
		point4.setName("name");
		point4.setObs("obs");
		point4.setType("type");		
		point4.setCoordenate(new Coordinates(-1, 0));
		...
		vertexes.add(new Coordinates(0, 1));
		vertexes.add(new Coordinates(1, 1));
		vertexes.add(new Coordinates(2, 1));
		vertexes.add(new Coordinates(3, 1));
