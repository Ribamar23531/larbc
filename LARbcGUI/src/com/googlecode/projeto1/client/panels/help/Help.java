...
public class Help extends Panel {
	...
	private String consultaString = "<html><font color=#000080><p></p><p><b><font size=3>Realizando uma consulta</font></b></p><p><br></br></p><p>Para realizar uma consulta o usuário deve seguir os seguintes passos:</p> " +
			"<p><br></br></p><p>1. Ao iniciar a aplicação clicar no botão <b>"+ "<img src='images/ENTRAR.PNG' WIDTH='80' HEIGHT='18'>" + "</b> </p>" +
			" <p><br></br></p><p>2. Na próxima tela aparecerá a pergunta <b>"+ "      "+ "<img src='images/questao.PNG' WIDTH='70' HEIGHT='18'>" + "      "+ "</b>, então o usuário deve clicar no botão <b>"+ "<img src='images/comprarButton.PNG' WIDTH='80' HEIGHT='22'>" + "</b> </p>"
	...
	private String loginAdministradorString = "<html><font color=#000080><p></p><p><b><font size=3>Administrando</font></b></p><p><br></br></p><p>Para administrar o <b>Meu Lar</b>, o usuário deve entrar na aplicação. Aparecerá a tela com a pergunta <b>"+"<img src='images/questao.PNG' WIDTH='70' HEIGHT='18'>"+"</b>, nessa tela, na parte superior direita está o botão <b>"+ "<img src='images/botaoAdministrar.PNG' WIDTH='60' HEIGHT='12'>" +"</b>, onde o usuário deve clicar. </p>" +
	...
	private String criarDemandaString = "<html><font color=#000080><p></p><p><b><font size=4>Criando uma demanda</font></b></p><p><br></br></p><p>O cliente pode criar uma demanda de duas formas:</p>" +
			...
			" <p><br></br></p><p>Para cadastrar um imóvel para venda o usuário deve fazer o seguinte: ao iniciar a aplicação clicar no botão <b>"+ "<img src='images/ENTRAR.PNG' WIDTH='80' HEIGHT='18'>" +"</b>, na tela seguinte clicar no botão </b>"+ "<img src='images/venderButton.PNG' WIDTH='80' HEIGHT='18'>" +"</b>. Aparecerá um formulário para ser preenchido pelo cliente com as informações de seu imóvel. Ao preencher o formulário o cliente deve clicar em <b>"+ "<img src='images/cadastrar.PNG' WIDTH='80' HEIGHT='18'>" +"</b>.</p>" +
